        ...
        setContentView(VisitorLandingBinding.inflate(layoutInflater).apply {
            ...
            callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                override fun onVerificationFailed(e: FirebaseException) {
                    ...
                    val toast: Toast = Toast.makeText(this@VisitorLandingActivity, e.message, Toast.LENGTH_SHORT)
                    toast.show()
                }
    ...
    override fun checkVisitorType(isEmployee: Boolean, empRole: String) {
        if(isEmployee){
            when(empRole){
                ...
                "A" -> startActivity(Intent(this@VisitorLandingActivity, AdminPanelActivity::class.java))
